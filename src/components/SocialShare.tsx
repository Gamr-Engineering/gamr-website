    ...
    <div className="flex items-center gap-4 py-8 border-t border-white/10 mt-12">
      ...
      <div className="flex gap-3">
        <a
          ...
          onClick={() => {
            if ((window as any).trackEvent) {
              (window as any).trackEvent("article_share", { platform: "twitter", url });
            }
          }}
        >
          {/* X / Twitter Icon */}
        ...
        <a
          ...
          onClick={() => {
            if ((window as any).trackEvent) {
              (window as any).trackEvent("article_share", { platform: "facebook", url });
            }
          }}
        >
          {/* Facebook Icon */}
        ...
        <a
          ...
          onClick={() => {
            if ((window as any).trackEvent) {
              (window as any).trackEvent("article_share", { platform: "linkedin", url });
            }
          }}
        >
          {/* LinkedIn Icon */}
